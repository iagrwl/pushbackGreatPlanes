...
void autonSkills() {
    ...
    wallDistance(true,true);
    scoringGate.set_value(true);
    chassis.moveToPoint(-47.5,-70,1500,{.maxSpeed=75},false);
    left_dt.move(-40);
    right_dt.move(-40);
    pros::delay(200);
    left_dt.move(90);
    ...
    //collect 2nd loader
    chassis.moveToPoint(-47.5,70,1800,{.maxSpeed=75},false);
    left_dt.move(-40);
    right_dt.move(-40);
    pros::delay(200);
    left_dt.move(90);
    ...
    chassis.moveToPose(-20,65,90,2500,{.minSpeed=70,.earlyExitRange=5},false);
    ...
    //frontIntake.move(-127);
    chassis.moveToPoint(12,66,1500,{.minSpeed=110},false);
    scoringGate.set_value(true);
    frontIntake.move(127);
    chassis.moveToPoint(18,66,1300,{.maxSpeed=100,.minSpeed=45},false);
    //pros::delay(500);
    loaderMech.set_value(false);
    //pros::delay(400);
    ...
    chassis.turnToPoint(44.5,48,500,{.minSpeed=70});
    chassis.moveToPoint(44.5,48,1500,{.maxSpeed=75,.minSpeed=60,.earlyExitRange=5});
    chassis.turnToHeading(0,700,{},false);
    wallDistance(true,true);
    chassis.moveToPoint(47.75,24,1500,{.forwards=false,.minSpeed=70});
    ...
    */
    ...
    chassis.moveToPoint(47.5,70,1800,{.maxSpeed=70},false);
    left_dt.move(-40);
    right_dt.move(-40);
    pros::delay(200);
    left_dt.move(90);
    ...
    chassis.turnToPoint(61,-34,700,{.minSpeed=60},false);
    scoringGate.set_value(true);
    wallDistance(true,false);
    ...
    */
    ...
    chassis.turnToPoint(49,-46,1000,{.minSpeed=60,.earlyExitRange=5});
    chassis.moveToPoint(49,-46,2000,{.maxSpeed=75,.minSpeed=60,.earlyExitRange=5});
    chassis.turnToHeading(180,500,{},false);
    wallDistance(true,false);
    chassis.moveToPoint(47.5,-70, 2000,{.minSpeed=60});
    pros::delay(700);
    */
